...
local volume_pct = sbar.add("item", {
	position = "right",
	padding_left = 0,
	padding_right = 0,
	label = {
...
items[volume_icon.name] = volume_icon.name
items[volume_slider.name] = volume_slider.name
items[volume_pct.name] = volume_pct.name
