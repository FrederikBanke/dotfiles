	...
	},
	{
		...
		opts = {
			...
			on_attach = function(bufnr)
				...
				end, { buffer = bufnr, desc = "Show blame for line" })
				vim.keymap.set(
					"n",
					"<leader>tb",
				...
				vim.keymap.set("n", "<leader>hd", gitsigns.diffthis, { buffer = bufnr, desc = "Show diff for hunk" })
				vim.keymap.set("n", "<leader>hD", function()
					gitsigns.diffthis("~")
				end, { buffer = bufnr, desc = "Show diff for whole buffer" })
				vim.keymap.set(
					"n",
					"<leader>td",
